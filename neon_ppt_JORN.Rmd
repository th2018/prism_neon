...
zipsByProduct(dpID="DP1.00006.001" # Precipitation
              , site= site, startdate = "2021-01", enddate =  "2021-12",
  package = "basic", avg = "all", check.size = TRUE, savepath = site,
  load = T)
```
...
```{r}
setwd(  "/Users/owner/Downloads/prism_neon-main/JORN/filesToStack00006")
list.files()
```
...
```{r}
df_JORN<-df0
save(df_JORN,file="df_JORN.Rdata")
```
